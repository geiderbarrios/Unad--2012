/**************************************
 * THEME NAME: content_personalizado
 *
 * Files included in this sheet:
 *
 *   content_personalizado/styles_layout.css
 *   content_personalizado/styles_fonts.css
 *   content_personalizado/styles_color.css
 *   content_personalizado/styles_tabs.css
 **************************************/

/***** content_personalizado/styles_layout.css start *****/
 ...
 *** Header
 ***/
/*Banner principal de toda la plataforma*/
#header-home {
  /*padding:0.7em 0;
  height:2em*/
  height:110px;
  background:url(pix/cabezotecampus.gif) left no-repeat;
}
#header,
#header-main,
.navbar {
...
/*Banner principal de toda la plataforma, esta ubicado dentro de la edicion de moodle*/
#header {
  /*padding:0.1em 0;
  height:50px*/
  height:110px;
...
/*barra que esta debajo del banner principal*/
.navbar {
  width:100%;
  margin:0;
  padding:0;
...
/***** content_personalizado/styles_layout.css end *****/

/***** content_personalizado/styles_fonts.css start *****/
...
/*tamaño y tipo de letra de toda la plantilla*/
body {
...
/*linea inferior que subraya los links*/
a:hover {
...
/*titulo principal que va en la parte superior izquierda del banner*/
#header-home .headermain {
  /*font-size:1.5em*/
  font-size:1.1em;
  color:#13487f;
}
/*titulo interno que va en la parte superior izquierda del banner*/
#header .headermain {
  /*font-size:1.3em*/
  font-size:1.1em;
  color:#13487f;
}
/*fuente de la barra de navegacion*/
.breadcrumb {
  font-size:0.8em;
  font-weight:normal
}
...
/***** content_personalizado/styles_fonts.css end *****/

/***** content_personalizado/styles_color.css start *****/
 ...
 ***  Core
 ***/
/*color de todos los links*/
a:link {
  color:#13487f;
}
/*color de los sublinks ya visitados*/
a:visited {
  color:#0025FC;
}
/*color de los links que al parecer no estan activos*/
a.dimmed:link,
a.dimmed:visited {
  color:#FF9D00;
}
/*color de los links cuando me coloco sobre ellos*/
a:hover {
  color:#0084ff;
}
a.autolink {
...
/*color del link,cuando yo hago click este aparece en la parte del medio superior*/
h1.main,
h2.main,
h3.main,
h4.main,
...
/*color de las flechitas de la barra de navegacion superior ruta de navegacion*/
.breadcrumb .sep {
  color:#13487f; 
}
/*color de notificacion de problemas*/
.notifyproblem {
  color:#CE001E;
}
.notifysuccess {
...
/*Color de las columnas internas de los cuadros de edicion en los campos obligatorios*/
.required {
  background-color:#FFEDCE
}
/*color de la columna del centro y su borde*/
.generalbox {
  border-color:#DDD;
...
/*color de la caja de error, (esta aparece dentro de servidor/ entorno*/
.errorbox {
  color:#FFFFFF;
  border-color:#000000;
...
/*color del borde del recuadro central*/
.sitetopiccontent {
  border-color:#5c96d3;
  background-color:#FFFFFF;
}
/*color dormido de las palabras dentro de "filtros"*/
.dimmed_text {
  color:#AAA
}
.teacheronly {
...
/*color de fondo y borde del encabezado de las tablas centrales*/
.generaltable th.header {
  background-color:#91B9E5;
  border-color:#cbdff9;
}
/*color segunda fila de las tablas del centro*/
.generaltable .r1 {
 ...
 *** Footer
 ***/
/*color de la barra inferior la que dice "usted se a auntenticado como*/
#footer {
  background-color:#91B9E5;
  border-top-color:#FFB63B
}
/*colores del boton inferior que dice pagina principal*/
.homelink a:link,
.homelink a:visited,
.homelink a:hover {
...
/*sombras del boton inferior que dice pagina principal*/
.homelink a:link,
.homelink a:visited {
...
/*sombras del boton inferior cuando me hago encima de el que dice pagina principal*/
.homelink a:hover {
 ...
 *** Admin
 ***/
 /*cuadro en el link informes dentro de el "tests unitarios"*/
.admin .generalboxcontent {
  background-color:#ffffff;
  color: #0057A5;
}
/*borde del cuadro en el link informes dentro de el "tests unitarios"*/
.admin .generalbox {
  border-color:#5c96d3; 
}
...
/*color del recuadro de edicion del calendario*/
#adminsettings fieldset {
  background-color:#ffffff;
  border-color:#5c96d3;
  color: #0057A5;
 ...
 *** Blocks
 ***/
/*color de toda la columna izquiera*/
.sideblock {
  border-color:#DDD;
  background-color:#C9DFF2;
}
/*color de las letras de la parte superior del cuadro de la izquierda y derecha*/
.sideblock .header {
  color:#ffffff;
}
.sideblock .header .commands {
...
/*color de la barra superior de la tabla de la izquierda*/
#left-column .sideblock .header {
  background-color:#91b9e5;
...
/*color de la barra superior del menu de edicion de moodle*/
#right-column .sideblock .header {
  background-color:#91b9e5;
  border-bottom-color:#CCDDEF
}
/*color de la columna derecha, es el menu de edicion de moodle*/
#right-column .sideblock .content {
  background-color:#c9dff2; 
}
.sideblock .link {
 ...
 *** Calendar
 ***/
/*color del recuadro del calendario interno grande*/
...
/*color del recuadro del mini calendario*/
table.minicalendar {
  border-color:#13487f;
}
...
/*color del recuadro que muestra dentro y fuera del calendario de las actividades a seguir*/
...
.minicalendar .duration_course {
  border-top-color:#c9dff2; !important;
  border-bottom-color:#c9dff2; !important
}
 ...
 *** Course
 ***/
/*color del recuadrito superior que aparece en edicion de bloques*/
#course-view .headingblock {
  border-left-color:#C9DFF2;
}
...
/*color delos recuadros  que aparece en edicion de bloques cunado se numeran las actividades*/
#course-view .section .left {
  background-color:#c9dff2;
}
#course-view .section .right {
...
/*color central de tabla interna*/
#course-user #content,
#user-view #content,
#user-edit #content,
.admin #content,
...
/*dentro de los foros de los cursos se encuentra una tabla este es el cabezote de la tabla*/
.forumheaderlist .header {
  background-color:#91B9E5;
  border-color:#000000;
}
...
/*dentro de los foros de los cursos se encuentra una tabla esta es la columna derecha que contiene el tema*/
...
/*color de las barras horizontales ubicadas en los glosarios de los cursos*/
.categoryheader {
  background-color:#C9DFF2;
}
...
/***** content_personalizado/styles_color.css end *****/

/***** content_personalizado/styles_tabs.css start *****/
...
.selected .tablink a:visited {
    color:#000000;
}/***** content_personalizado/styles_tabs.css end *****/
