...
.mod-lesson .progress_bar_completed {
    ...
    background-image: url(http://66.165.175.232/campus02/mod/lesson/completed.gif);
...
.mod-lesson .progress_bar_todo {
    /*  Example Use of Image
    background-image: url(http://66.165.175.232/campus02/mod/lesson/todo.gif);
    background-repeat: repeat-x;
    background-position: center;
    */
...
.mod-lesson .progress_bar_token {
    /*  Example Use of Image
    background-image: url(http://66.165.175.232/campus02/mod/lesson/token.gif);
